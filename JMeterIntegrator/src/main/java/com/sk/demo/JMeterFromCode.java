    ...
    public static void main(String[] args) throws Exception {
        ...
        if (jmeterHome.exists()) {
            ...
            if (jmeterProperties.exists()) {
                ...
                examplecomSampler.setPath("/api/v1/employee/72632");
                examplecomSampler.setMethod("GET");
                examplecomSampler.setName("Access dummy employee api");
                examplecomSampler.setProperty(TestElement.TEST_CLASS, HTTPSamplerProxy.class.getName());
                examplecomSampler.setProperty(TestElement.GUI_CLASS, HttpTestSampleGui.class.getName());
                examplecomSampler.setName("HTTPExampleSampler");
                ...
                argumentList.add(new Argument("graphitePort","2003"));
                argumentList.add(new Argument("samplersList","HTTPExampleSampler;"));
                argumentList.add(new Argument("graphiteMetricsSender" , "org.apache.jmeter.visualizers.backend.graphite.TextGraphiteMetricsSender"));
